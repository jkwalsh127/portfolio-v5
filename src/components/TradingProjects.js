    ...
    return (
        <article class='work-card-bot'>
            <div class='work-card-head'>
                <a href='https://jkwalsh127.github.io/btc-bot/' target='_blank'>
            ...
            <a href='https://jkwalsh127.github.io/btc-bot/' target='_blank'>
                <img src='' id='bot-img' alt='placeholder image for Bitcoin trading bot' />
            </a>
            <p class="text-barlow" id='card-description-no-repo'>
                ...
                <a href='https://github.com/jkwalsh127/btc-bot' target='_blank'>
                ...
                <div class='technologies-div'>
                    ...
                    <img src='' id='pine-script-img' alt='placeholder image for pinescript and tradingview' />
                </div>
            </p>
        </article> 
    )
